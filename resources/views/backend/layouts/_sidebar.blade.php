    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="dashboard" class="nav-link @if( Request::segment(2) == 'dashboard') active @endif">
          ...
          <li class="nav-item">
            <a href="{{ url('admin/portfolio')}}" class="nav-link @if( Request::segment(2) == 'portifolio') active @endif">
              <i class="nav-icon fa fa-briefcase"></i>
              <p>
                Portifolio
              </p>
